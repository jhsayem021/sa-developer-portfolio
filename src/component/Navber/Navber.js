...
import './Navber.css'
import resume from '../../Resume/Jahid_Hossain_Sayem.pdf'
const Navber = () => {
    return (
  ...
  <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
    <div className="relative flex items-center justify-between h-16">
      ...
      <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
        ...
        <div className="hidden sm:block sm:ml-6">
          <div className="flex space-x-4 navlink">
            ...
            <Link href="#" className="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium no-underline">About</Link>
      ...
      <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
        ...
        {/* <!-- Profile dropdown --> */}
        <div className="ml-3 relative navlink">
        <Link href={resume} className="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium" download >Download Resume</Link>
        </div>
      </div>
    </div>
  </div>
